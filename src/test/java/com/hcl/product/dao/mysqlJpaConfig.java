...
//@Configuration
//@EnableJpaRepositories(basePackages = "com.hcl.product")
public class mysqlJpaConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/product_schema");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "com.hcl.product" });
